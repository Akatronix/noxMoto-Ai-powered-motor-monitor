      ...
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden lg:flex flex-col items-start space-y-8">
          ...
          <h2 className="text-4xl font-black text-white leading-tight tracking-tight">
            Monitor Your Motors with{" "}
            <span className="text-[#10b981]">Smart IoT</span>
          </h2>

          <p className="text-base text-gray-500 leading-relaxed max-w-md">
            Join operators who trust noxMoto to monitor motor current,
            temperature and vibration for predictive maintenance.
          </p>
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-[10px] font-bold uppercase mt-1.5 tracking-widest">
              Start monitoring your motors today
            </p>
